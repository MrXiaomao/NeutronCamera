    ...
    , mAnalysisWorker(nullptr)
{
    ...
    connect(ui->toolButton_waveform, &QToolButton::clicked, this, &OfflineWindow::onWaveform);
    connect(ui->toolButton_NGamma, &QToolButton::clicked, this, &OfflineWindow::onNGammaFilter);
    connect(ui->toolButton_process, &QToolButton::clicked, this, &OfflineWindow::onDataProcess);
...
void OfflineWindow::dragEnterEvent(QDragEnterEvent *event)
{
...
void OfflineWindow::dropEvent(QDropEvent *event)
{
...
void OfflineWindow::on_action_about_triggered()
{
...
void OfflineWindow::on_action_aboutQt_triggered()
{
...
// 计算文件信息列表的总大小
qint64 OfflineWindow::calculateTotalSize(const QFileInfoList& fileinfoList)
{
    qint64 totalSize = 0;
...
void OfflineWindow::initWaveformPage()
{
...
void OfflineWindow::initNGammaPage()
{
...
void OfflineWindow::initCpsPage()
{
    const int channelCount = 18; // 通道总数
...
void OfflineWindow::onFoMPlot(quint8 cameraIndex, QPair<double,double> xlim, const QVector<FOM_CurvePoint>& pairs, double fom)
{
    // FoM图绘
    // 核密度图谱
    QCustomPlot* customPlot = nullptr;
...
void OfflineWindow::onSpectrumPlot(QMap<quint8/*通道号*/, QMap<quint16/*道址*/,quint32/*计数率*/>> mapPairs)
{
...
void OfflineWindow::onCpsPlot(QMap<quint8/*通道号*/, QMap<quint16/*时刻*/,quint32/*计数率*/>> mapPairs)
{
...
void OfflineWindow::on_action_process_triggered()
{
...
/////////////////////////////////////////////////////////////////////////////////////////////////////
/// \brief OfflineWindow::onDataProcess
QString OfflineWindow::humanReadableSize(qint64 bytes)
{
...
void OfflineWindow::onDataProcess()
{
    // 设置参数
    ...
    connect(mAnalysisWorker, &DataAnalysisWorker::logMessage,
            this, &OfflineWindow::onAnalysisLogMessage, Qt::QueuedConnection);
    connect(mAnalysisWorker, &DataAnalysisWorker::progressUpdated,
            this, &OfflineWindow::onAnalysisProgress, Qt::QueuedConnection);
    connect(mAnalysisWorker, &DataAnalysisWorker::analysisFinished,
            this, &OfflineWindow::onAnalysisFinished, Qt::QueuedConnection);
    connect(mAnalysisWorker, &DataAnalysisWorker::analysisError,
            this, &OfflineWindow::onAnalysisError, Qt::QueuedConnection);
...
void OfflineWindow::onAnalysisFinished(bool success, const QString& message)
{
    // 恢复UI状态
...
/////////////////////////////////////////////////////////////////////////////////////////////////////
#include "n_gamma.h"
void OfflineWindow::onNGammaFilter()
{
...
void OfflineWindow::onNeutronSpectrum(quint8 cameraIndex, const QVector<double>& x, const QVector<double>& y)
{
...
void OfflineWindow::onGammaSpectrum(quint8 cameraIndex, const QVector<double>& x, const QVector<double>& y)
{
    quint8 cameraOrientation = cameraIndex <= 11 ? PCIeCommSdk::CameraOrientation::Horizontal : PCIeCommSdk::CameraOrientation::Vertical;
...
/////////////////////////////////////////////////////////////////////////////////////////////////////
void OfflineWindow::onCpsStatistics(int minPeak, int maxPeak)
{
    mWaitingSpinnerWidget->start();
...
void OfflineWindow::on_action_home_triggered()
{
...
void OfflineWindow::on_action_save_triggered()
{
...
void OfflineWindow::on_action_cfgParam_triggered()
{
